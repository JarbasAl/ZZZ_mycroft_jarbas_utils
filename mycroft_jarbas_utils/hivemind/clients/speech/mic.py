...
from mycroft_jarbas_utils.hivemind.clients.speech.signal import *
...
class ResponsiveRecognizer(speech_recognition.Recognizer):
    ...
    def _upload_file(self, filename):
        # disable upload
        # hivemind = self.upload_config['hivemind']
        ...
        #    hivemind + ':' + self.upload_config['folder']
        ...
        #            os.remove(fn)
        #        else:
        #            LOG.debug('Could not upload ' + fn + ' to ' + hivemind)
        # finally:
